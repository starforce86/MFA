...
input VideoDataForMonthWhereInput {
  ...
  avg_minutes_watched_in: [Float!]
  avg_minutes_watched_not_in: [Float!]
  ...
  exponent_applied_in: [Float!]
  exponent_applied_not_in: [Float!]
  ...
  minutes_after_exponent_in: [Float!]
  minutes_after_exponent_not_in: [Float!]
