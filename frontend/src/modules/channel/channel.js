                        ...
                        <div className="single-channel-page" id="content-wrapper">
                            ...
                            <div className="container-fluid">
                                <div className="video-block section-padding">
                                    {
                                        (this.props.user && this.props.user.my_videos && this.props.user.my_videos.filter(v => v.deleted == false).length > 0) ?
                                            <div className="row">
                                                {this.props.user.my_videos.filter(v => v.deleted == false).map(v => <Video video={v} key={v.id}/>)}
                                            </div> :
                                            <div className="row">
